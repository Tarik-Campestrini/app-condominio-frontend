...
const Index = () => {
  ...
  const { signin } = useAuth(); // 🔹 Agora usamos o contexto de autenticação
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        signin(data.token); // 🔹 Atualiza o contexto imediatamente
        alert("Login bem-sucedido!");
        navigate("/home", { replace: true }); // 🔹 Redireciona corretamente
      } else {
